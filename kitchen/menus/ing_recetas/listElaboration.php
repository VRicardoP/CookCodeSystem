<div id="receta" class="tabcontent">
    ...
    <p>Here you can see the elaborateds.</p>
    <div class="card shadow mb-4 ">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table class="display" id="tableElaborates">
                    <thead>
                        <tr>
                            <th>Image</th>
                            <th>Name</th>
                    ...
                    <tbody id="receta-tbody">
                        ...
                        $queryReceta = "SELECT * FROM `recetas` WHERE `tipo` = 'Elaborado'";
                        ...
                        foreach ($recetas as $rowReceta) {
                            ...
                            echo '<td>' . $rowReceta["num_raciones"] . '</td>';
                            echo '<td>' . $rowReceta["localizacion"] . '</td>';
                            echo '<td>' . $rowReceta["empaquetado"] . '</td>';
                            echo '<td>' . $rowReceta["expira_dias"] . '</td>';
