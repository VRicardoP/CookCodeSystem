...
-- Tiempo de generación: 21-10-2025 a las 11:37:34
...
CREATE TABLE IF NOT EXISTS `alergenos` (
  ...
  `nombre_ingles` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_frances` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_aleman` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `almacenelaboraciones`;
CREATE TABLE IF NOT EXISTS `almacenelaboraciones` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `tipoProd` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `fName` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `packaging` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `productamount` int NOT NULL,
  `fechaElab` date NOT NULL,
  `fechaCad` date NOT NULL,
  `warehouse` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `costCurrency` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `costPrice` float NOT NULL,
  `saleCurrency` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `salePrice` float NOT NULL,
  `codeContents` text COLLATE utf8mb4_general_ci NOT NULL,
  `receta_id` int DEFAULT NULL,
  `rations_package` int DEFAULT NULL COMMENT 'Numero de unidades por paquete',
  `fileName` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `almaceningredientes`;
CREATE TABLE IF NOT EXISTS `almaceningredientes` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `tipoProd` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `fName` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `packaging` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `estado` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_ingrediente_id` (`ingrediente_id`)
...
CREATE TABLE IF NOT EXISTS `elaboraciones` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `fName` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `receta` int NOT NULL COMMENT 'Receta del elaborado',
  `merma` float DEFAULT NULL,
  `packaging` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `productamount` int NOT NULL,
  `fechaElab` date NOT NULL,
  `caducidad` int NOT NULL COMMENT 'Cuantos días tarda en caducar',
  `warehouse` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `costCurrency` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `costPrice` int NOT NULL,
  `saleCurrency` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `salePrice` int NOT NULL,
  `codeContents` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `image` longblob,
  PRIMARY KEY (`ID`),
  KEY `FK_id_receta` (`receta`)
...
DROP TABLE IF EXISTS `ingredientesalergenos`;
CREATE TABLE IF NOT EXISTS `ingredientesalergenos` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ingredients` (
  ...
  `expira_dias` int DEFAULT NULL,
  `peso` float DEFAULT NULL,
  `atr_name_tienda` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `atr_valores_tienda` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_corta` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `clasificacion_ing` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
DROP TABLE IF EXISTS `pedidos_ecommerce`;
CREATE TABLE IF NOT EXISTS `pedidos_ecommerce` (
  ...
  `email_cliente` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `estado_envio` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `productos_pedido` (
  ...
  `sku_producto` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `cantidad` int NOT NULL,
  `informacion_lote` text COLLATE utf8mb4_general_ci,
  `sku_lote` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `recetas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `receta` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nombre de la receta',
  `instrucciones` text COLLATE utf8mb4_general_ci NOT NULL,
  `produce` int DEFAULT NULL COMMENT 'Que elaborado produce',
  `cantidad_producida` int NOT NULL,
  `tipo_cantidad` int NOT NULL,
  `peso` float NOT NULL,
  `num_raciones` int DEFAULT NULL COMMENT 'Número de raciones indicadas para la receta',
  `imagen` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `expira_dias` int DEFAULT NULL COMMENT 'Días hasta su caducidad',
  `localizacion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `empaquetado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `receta_elaborado`;
CREATE TABLE IF NOT EXISTS `receta_elaborado` (
  `id` int NOT NULL AUTO_INCREMENT,
  `receta` int NOT NULL,
  `elaborado` int NOT NULL,
  `cantidad` float NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_receta_elaborado_receta` (`receta`),
  KEY `fk_receta_elaborado_elaborado` (`elaborado`)
...
CREATE TABLE IF NOT EXISTS `receta_ingrediente` (
  `id` int NOT NULL AUTO_INCREMENT,
  `receta` int DEFAULT NULL COMMENT 'Receta que necesita este ingrediente/elaborado',
  `ingrediente` int DEFAULT NULL COMMENT 'Ingrediente necesario para la receta',
  `elaborado` int DEFAULT NULL COMMENT 'Elaborado requerido en la receta (se especifica o bien 1 ingrediente o 1 elaborado)',
  `cantidad` float DEFAULT NULL,
  `tipo_cantidad` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_id_tipo_cantidad` (`tipo_cantidad`),
  KEY `FK_id_ingredients` (`ingrediente`),
  KEY `receta` (`receta`),
  KEY `FK_id_elaborado` (`elaborado`)
...
DROP TABLE IF EXISTS `stock_elab_kitchen`;
CREATE TABLE IF NOT EXISTS `stock_elab_kitchen` (
  `id` int NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `stock_ing_kitchen`;
CREATE TABLE IF NOT EXISTS `stock_ing_kitchen` (
  `id` int NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `stock_lotes_elab`;
CREATE TABLE IF NOT EXISTS `stock_lotes_elab` (
  `id` int NOT NULL AUTO_INCREMENT,
  `receta_id` int NOT NULL,
  `lote` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `cantidad` int NOT NULL,
  `unidades` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `elaboracion` date NOT NULL,
  `caducidad` date NOT NULL,
  `coste` decimal(10,2) NOT NULL,
  `tipo_unidad` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
DROP TABLE IF EXISTS `stock_lotes_ing`;
CREATE TABLE IF NOT EXISTS `stock_lotes_ing` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ingrediente_id` int NOT NULL,
  ...
  `caducidad` date NOT NULL,
  `coste` float DEFAULT NULL,
  `tipo_unidad` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
DROP TABLE IF EXISTS `tagscreados`;
CREATE TABLE IF NOT EXISTS `tagscreados` (
  `IDTag` int NOT NULL AUTO_INCREMENT,
  `tempDir` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `filename` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `fName` varchar(125) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Product name',
  `packaging` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `productamount` int NOT NULL,
  `fechaElab` date NOT NULL,
  `fechaCad` date NOT NULL,
  `warehouse` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `costCurrency` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `costPrice` int NOT NULL,
  `saleCurrency` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `salePrice` int NOT NULL,
  `codeContents` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`IDTag`)
...
DROP TABLE IF EXISTS `tagselaboraciones`;
CREATE TABLE IF NOT EXISTS `tagselaboraciones` (
  `IDTag` int NOT NULL AUTO_INCREMENT,
  `tempDir` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `filename` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `image` longblob,
  `receta_id` int DEFAULT NULL,
  `rations_package` int DEFAULT NULL,
  `expira_dias` int DEFAULT NULL,
  PRIMARY KEY (`IDTag`),
  KEY `fk_receta_tag` (`receta_id`)
...
DROP TABLE IF EXISTS `tagselaboraciones_ingredients`;
CREATE TABLE IF NOT EXISTS `tagselaboraciones_ingredients` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tag_elaboracion_id` int DEFAULT NULL,
  `ingrediente` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cantidad` float DEFAULT NULL,
  `unidad` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alergeno` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tag_elaboracion_id` (`tag_elaboracion_id`)
...
DROP TABLE IF EXISTS `tagsingredientes`;
CREATE TABLE IF NOT EXISTS `tagsingredientes` (
  `IDTag` int NOT NULL AUTO_INCREMENT,
  `tempDir` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `filename` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  PRIMARY KEY (`IDTag`),
  KEY `fk_ingrediente_id_tags` (`ingrediente_id`)
...
DROP TABLE IF EXISTS `tagspreelaboraciones`;
CREATE TABLE IF NOT EXISTS `tagspreelaboraciones` (
  `IDTag` int NOT NULL AUTO_INCREMENT,
  `tempDir` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
  `filename` varchar(125) COLLATE utf8mb4_general_ci NOT NULL,
...
DROP TABLE IF EXISTS `tagspreelaboraciones_ingredients`;
CREATE TABLE IF NOT EXISTS `tagspreelaboraciones_ingredients` (
  `id` int NOT NULL AUTO_INCREMENT,
  `preelaboracion_id` int DEFAULT NULL,
  `ingrediente` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cantidad` float DEFAULT NULL,
  `unidad` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alergeno` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `preelaboracion_id` (`preelaboracion_id`)
...
DROP TABLE IF EXISTS `traduccionesingredientes`;
CREATE TABLE IF NOT EXISTS `traduccionesingredientes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_ingles` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_espanol` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_frances` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_aleman` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
);
...
--
ALTER TABLE `pedido_producto`
  ADD CONSTRAINT `fk_producto` FOREIGN KEY (`producto_id`) REFERENCES `ingredients` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
